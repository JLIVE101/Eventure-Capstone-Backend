...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 04, 2016 at 12:52 AM
...
--
CREATE DATABASE IF NOT EXISTS `eventure_db` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `eventure_db`;
...
(1, 'High Fashion High Tea Fundraiser', '<p><strong>NOTICE: Purchase tickets by October 16, 2016 cut-off date.</strong></p>\n<p>High Fashion High Tea is a special afternoon event that connects the world of fashion and&nbsp;health together with the single goal of making a difference. Hosted at the unique Waterside Inn by the lake in Port Credit, the event raises funds and awareness for the Canadian Cancer Society.</p>\n<p>High Fashion High Tea provides guests with an afternoon of socializing while shopping and&nbsp;enjoying high tea and a fashion show featuring international women''s wear designer collections&nbsp;that promise to dazzle and inspire. Featuring the latest fashion trends, Studio 49 is graciously&nbsp;giving everyone a $50 gift certificate to be used in-store.</p>\n<p>This event is dedicated to raising funds for the Canadian Cancer Society. Visit our <a title="High Fashion High Tea Oct 23 2016" href="http://highfashionhightea.ca/sample-page/about-the-fashion-show/" target="_blank" rel="noopener noreferrer nofollow">web page here</a> to view details about the event and our donors.</p>', 29, 'http://localhost:9000/uploads/events/b900cc9f-e444-48d8-be47-2a05ebef11af.evbuc', '15 Stavebank Rd S, Mississauga, ON L5G 2T2, Canada', 0, NULL, '2016-10-23 14:00:00', '2016-10-23 17:00:00', 0, '2016-10-17 15:26:40', '2016-10-19 06:25:32', '43.5516770000', '-79.5842483000'),
...
(23, 'NACS Formal 2016 - Around The World', '<div class="has-user-generated-content js-d-read-more read-more js-read-more read-more--medium-down read-more--collapsed read-more--contents-overflow" data-xd-wired="read-more">\n<div class="js-xd-read-more-toggle-view read-more__toggle-view">\n<div class="js-xd-read-more-contents l-mar-top-3">\n<p>The North American Culture Show Presents&nbsp;<br /><br />&diams;&diams;&diams; AROUND THE WORLD &diams;&diams;&diams;<br /><br />The 5th annual NACS Formal and the OFFICIAL Launch for North American Culture Show 2017<br /><br />&diams;It&rsquo;s All Taking Place At &diams;<br /><br />&diams;&loz;&diams; Apollo Convention Centre &diams;&loz;&diams;<br />&diams; 6591 Innovator Drive&diams;<br />&diams; Mississauga, ON&diams;<br /><span class="text_exposed_show"><br /><br />☰☰☰ FRIDAY, NOVEMBER 11th 2016 ☰☰☰<br />☰☰☰☰ Doors Open at 6pm ☰☰☰☰<br />☰☰☰☰ Dinner from 7PM-9PM ☰☰☰☰<br />☰☰☰Doors Close at 11pm SHARP ☰☰☰<br /><br /><br />For more details/questions regarding this event contact info@nacultureshow.com or message our facebook page with your inquires.<br /><br />_____________________________________________<br /><br />The participants for NACS 2017 will bring down the house with;&nbsp;<br /><br />► Teaser Performances ◄<br /><br />and YOU will decide who will win the teaser dance off!!&nbsp;<br /><br />&loz; Winner will be determined by crowd reaction &loz;<br /><br />_____________________________________________<br /><br />&gt;UNI/COLLEGE EVENT! WRISTBAND POLICY IN EFFECT&lt;&nbsp;<br />&gt;FORMAL DRESS CODE IN EFFECT &lt;<br />&gt;R.O.A.R. IN EFFECT&lt;<br />&gt;*HALAL OPTIONS WILL BE AVAILABLE*&lt;</span></p>\n</div>\n</div>\n<div class="js-xd-read-more-toggle-director read-more__toggle-director l-pad-bot-4 l-sm-pad-bot-3"><a class="read-more__more" data-read-type="ReadMore" data-checkpoint-name="read_more">Read more</a> <a class="read-more__less" data-read-type="ReadLess" data-checkpoint-name="read_less">Read less</a></div>\n</div>', 41, 'http://localhost:9000/uploads/events/c6e85e1f-6e56-453b-b478-69e73d95a471.evbuc', '6591 Innovator Dr, Mississauga, ON L5T 2J3, Canada', 1, '$2a$10$uTR6fF9IzpMBkC7lxr6Lsumx6gQrAnvORkaaaSqykPAEXTqPcMTbW', '2016-11-11 18:00:00', '2016-11-12 00:00:00', 0, '2016-10-19 11:08:38', '2016-10-19 11:15:52', '43.6453826000', '-79.6870625000'),
(24, 'Drum Circle', '<div class="has-user-generated-content js-d-read-more read-more js-read-more read-more--medium-down read-more--collapsed read-more--contents-overflow" data-xd-wired="read-more">\n<div class="js-xd-read-more-toggle-view read-more__toggle-view">\n<div class="js-xd-read-more-contents l-mar-top-3">\n<p class="gmail_msg">It''s the very first<a title="Orrett Music Academy" href="http://www.orrrettmusicacademy.com" target="_blank" rel="noopener noreferrer nofollow">&nbsp;<span class="lG">Orrett</span>&nbsp;Music Academy</a> Drum Circle! And you are invited!! All are welcome, from ages 8 and up, beginner to advanced, to join the circle and have some fun drumming.</p>\n<p class="gmail_msg">Learn new methods and make some new friends as&nbsp;<span class="lG">Orrett</span>&nbsp;drum instructor Charlie McKittrick leads the circle through group-oriented exercises that focus on the basic fundamentals of rhythm, improvisation, listening and timing.</p>\n<p class="gmail_msg">Rhythm is an innate human instinct that lives inside all of us. If you can tap your foot, you can drum! You can drum alone or with friends in the living room, at the campsite, in your car and so many other places! It''s time to connect with your inner drummer and feel the rhythmic energy flow through you.</p>\n</div>\n</div>\n<div class="js-xd-read-more-toggle-director read-more__toggle-director l-pad-bot-4 l-sm-pad-bot-3"><a class="read-more__more" data-read-type="ReadMore" data-checkpoint-name="read_more">Read more</a> <a class="read-more__less" data-read-type="ReadLess" data-checkpoint-name="read_less">Read less</a></div>\n</div>', 41, 'http://localhost:9000/uploads/events/c178346a-49f5-4cac-b391-1d2d0e55e35a.evbuc', '3107 Bloor St W, Etobicoke, ON M8X 1E2, Canada', 0, NULL, '2016-11-02 19:00:00', '2016-11-02 20:00:00', 0, '2016-10-19 11:11:10', '2016-10-19 11:11:10', '43.6460797000', '-79.5160644000'),
